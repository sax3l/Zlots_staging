...
function mercury_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'                  => 'mercury-addons',
			'source'                => 'https://s3.eu-central.stackpathstorage.com/mercurytheme/plugins/3.9.3/mercury-addons-2.6.1.zip',
			'required'              => true,
			'version'               => '2.6.1',
			'force_activation'      => false,
			'force_deactivation'    => false,
		...
		array(
			...
			'slug'                  => 'aces',
			'source'                => 'https://s3.eu-central.stackpathstorage.com/mercurytheme/plugins/3.9.3/aces-3.0.2.zip',
			'required'              => true,
			'version'               => '3.0.2',
			'force_activation'      => false,
			'force_deactivation'    => false,
...
function mercury_import_files() {
  ...
  return array(
    ...
    array(
      ...
      'import_customizer_file_url'   => 'https://s3.eu-central.stackpathstorage.com/mercurytheme/demo/013/options.dat',
      'import_file_url'              => 'https://s3.eu-central.stackpathstorage.com/mercurytheme/demo/013/content.xml',
      'import_widget_file_url'       => 'https://s3.eu-central.stackpathstorage.com/mercurytheme/demo/013/widgets.wie',
      'import_preview_image_url'     => 'https://s3.eu-central.stackpathstorage.com/mercurytheme/images/013.jpg',
      'import_notice'                => esc_html__( 'Please waiting for a few minutes, do not close the window or refresh the page until the data is imported.', 'mercury' ),
