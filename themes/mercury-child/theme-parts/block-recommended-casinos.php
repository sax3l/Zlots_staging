...
?>
<section class="recommended-casinos-section">
                    ...
                    <div class="bottom-section">
                        <div class="row row1">
                            <div class="item">
                                ...
                                <span class="regular-text">Bonus Amount</span>
                            </div>
                            <div class="item">
                                <span class="big-text"><?php echo $bonus_percentage ?: 'N/A'; ?></span>
                                <span class="regular-text">Bonus Percentage</span>
                            </div>
                        </div>
                        <div class="row row2">
                            <div class="item">
                        ...
                        <div class="row row1">
                            <div class="item">
                                ...
                                <?php else: ?>
                                    <a class="link-button dark-link-button" href="#">Not Available</a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="row row1">
                            <div class="item">
                                ...
                                <?php else: ?>
                                    <a class="link-button red-link-button" href="#">Not Available</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
